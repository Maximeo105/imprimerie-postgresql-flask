...
DF1: NO\_LIVRAISON -> NO\_BON\_LIVRAISON, NOTES\_LIVRAISON, QUANTITE\_LIVRAISON, DATE\_LIVRAISON, ADRESSE\_LIVRAISON, VILLE\_LIVRAISON, CODE\_POSTAL\_LIVRAISON, COUT\_LIVRAISON


*Un numéro de commande unique est générée pour chaque commande

DF2: NO\_COMMANDE -> NO\_CLIENT, DATE\_COMMANDE, DATE\_LIMITE\_COMMANDE, PO\_CLIENT\_COMMANDE, QUANTITE\_COMMANDE, TYPE\_IMPRESSION, FORMAT\_FINAL\_IMPRESSION, FORMAT\_OUVERT\_IMPRESSION, RECTO\_VERSO\_IMPRESSION
...
**NO\_COMMANDE,** **NO\_LIVRAISON,**
 *Pour satisfaire la 1NF, NO\_LIVRAISON prendrait toujours une valeur par défaut, même s'il n'y a pas de livraison.*
